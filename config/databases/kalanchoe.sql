...
--
-- Host: localhost    Database: kalanchoe
-- ------------------------------------------------------
...
--
-- WHERE:  data_probeset_id='Kaladp0001s0001' and sample_id=1

LOCK TABLES `sample_data` WRITE;
/*!40000 ALTER TABLE `sample_data` DISABLE KEYS */;
INSERT INTO `sample_data` VALUES ('1',1,'Kaladp0001s0001',6.2003,'WL_Dawn_rep1');
...
-- Dump completed on 2023-06-07 19:30:27
