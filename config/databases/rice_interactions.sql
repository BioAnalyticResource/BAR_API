...
-- Author: Vincent Lau
-- Description: A replicate of the older rice_interactions database, datatypes  kept the same.
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `rice_interactions` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `interactions`(`Protein1`,`Protein2`,`Total_hits`,`Num_species`, `Quality`,`Pcc`) VALUES 
('LOC_Os01g01080','LOC_Os01g52560',1,1,1,0.65),
('LOC_Os01g01080','LOC_Os01g62244',1,1,1,0),
('LOC_Os01g01080','LOC_Os01g70380',2,1,2,0.789),
('LOC_Os01g52560', 'LOC_Os01g73310',1,1,1,-0.116);
...
CREATE TABLE `Rice_mPLoc` (
  ...
  `gfp` text DEFAULT NULL,
  `mass_spec` text DEFAULT NULL,
  `swissprot` text DEFAULT NULL,
  `amigo` text DEFAULT NULL,
  `annotation` text DEFAULT NULL,
  `pred_ipsort` text DEFAULT NULL,
  `pred_mitopred` text DEFAULT NULL,
  `pred_mitopred2` text DEFAULT NULL,
  `pred_predator` text DEFAULT NULL,
  `pred_peroxp` text DEFAULT NULL,
  `pred_subloc` text DEFAULT NULL,
  `pred_targetp` text DEFAULT NULL,
  `pred_wolfpsort` text DEFAULT NULL,
  `pred_multiloc` text DEFAULT NULL,
  `pred_loctree` text DEFAULT NULL,
  `pred_mPLoc` text DEFAULT NULL,
  PRIMARY KEY (`gene_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Rice_mPLoc` (`gene_id`, `pred_mPLoc`) VALUES 
...
-- Dump completed on 2021-01-22  1:08:05