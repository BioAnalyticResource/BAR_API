...
--
-- Host: localhost    Database: selaginella
-- ------------------------------------------------------
...
--
-- WHERE:  data_probeset_id='Smo402070' and sample_id=1

LOCK TABLES `sample_data` WRITE;
/*!40000 ALTER TABLE `sample_data` DISABLE KEYS */;
INSERT INTO `sample_data` VALUES (1,'1','Smo402070',6.03305,'Aerial-parts_37C_1h1');
...
-- Dump completed on 2023-06-08 21:49:19
