...
CREATE TABLE `protein_reference` (
  ...
  INDEX `protein_gene_id_idx` (`gene_identifier`)
  -- UNIQUE KEY `gene_identifier_UNIQUE` (`gene_identifier`)
  -- NB: UNIQUE KEY `gene_identifier_UNIQUE` (`gene_identifier`) is not used, as there are some duplicates in soybean dataset
  -- Instead: CREATE INDEX protein_gene_id_idx ON protein_reference (gene_identifier);
) ENGINE=InnoDB AUTO_INCREMENT=88178 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `protein_reference` VALUES (18,'GLYMA.01G000100','KRH74114');
INSERT INTO `protein_reference` VALUES (19,'GLYMA.01G000200','KRH74115');
INSERT INTO `protein_reference` VALUES (20,'GLYMA.01G000300','KRH74115');
...
) ENGINE=InnoDB AUTO_INCREMENT=22398414 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `snps_reference` VALUES (54848,1,27721,'C','A','Gm_H002');
INSERT INTO `snps_reference` VALUES (54849,1,27721,'C','A','Gm_H003');
INSERT INTO `snps_reference` VALUES (54850,1,27721,'C','A','Gm_H004');
...
INSERT INTO `snps_to_protein` VALUES (54848,18,250,'G','T',84,'Val','Phe','transcript','MODERATE',NULL);
INSERT INTO `snps_to_protein` VALUES (54849,18,250,'G','T',84,'Val','Phe','transcript','MODERATE',NULL);
INSERT INTO `snps_to_protein` VALUES (54850,18,250,'G','T',84,'Val','Phe','transcript','MODERATE',NULL);
...
INSERT INTO `sample_lookup` VALUES ('Gm_H002', 'Torkamaneh_Laroche_2019', 'X5302-1-52-3-2-B');
INSERT INTO `sample_lookup` VALUES ('Gm_H003', 'Torkamaneh_Laroche_2019', 'OACInwood');
INSERT INTO `sample_lookup` VALUES ('Gm_H004', 'Torkamaneh_Laroche_2019', 'OACDrayton');
...
-- Dump completed on 2022-03-22  13:22:26
