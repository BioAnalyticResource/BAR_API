...
--
-- Host: localhost    Database: phelipanche
-- ------------------------------------------------------
...
--
-- WHERE:  data_probeset_id='OrAeBC5_1.1' and sample_id=1

LOCK TABLES `sample_data` WRITE;
/*!40000 ALTER TABLE `sample_data` DISABLE KEYS */;
INSERT INTO `sample_data` VALUES ('1',1,'OrAeBC5_1.1',7.91,'Seed_Germination');
...
-- Dump completed on 2023-06-12  0:40:07
