...
class TestIntegrations(TestCase):
    ...
    def test_get_efp_image(self):
        ...
        response = self.app_client.get("/efp_image/abc/Developmental_Map/Absolute/At1g01010")
        expected = {"wasSuccessful": False, "error": "Invalid eFP."}
        self.assertEqual(response.json, expected)

        # Test for eFP view name
        response = self.app_client.get("/efp_image/efp_arabidopsis/ab.!c/Absolute/At1g01010")
        ...
        response = self.app_client.get("/efp_image/efp_arabidopsis/Root/Absolute/At1g0101X")
        expected = {"wasSuccessful": False, "error": "Gene 1 is invalid."}
        self.assertEqual(response.json, expected)

        response = self.app_client.get("/efp_image/efp_arabidopsis/Developmental_Map/Absolute/At1g01011")
        expected = {
            "wasSuccessful": False,
        ...
        # Test for gene 1 using Arabidopsis
        response = self.app_client.get("/efp_image/efp_arabidopsis/Root/Compare/At1g01010/Abc")
