...
class TestIntegrations(TestCase):
    ...
    def test_get_thaleme_gene_rifs(self):
        ...
        with open('tests/data/get_thaleme_gene_rifs_1.json') as json_file:
        ...
        with open('tests/data/get_thaleme_gene_rifs_2.json') as json_file:
            expected = load(json_file)
        self.assertEqual(response, expected)
