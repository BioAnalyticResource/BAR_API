...
class Interactions(db.Model):
    ...
    S_cerevisiae: db.Mapped[int] = db.mapped_column(db.SmallInteger(), primary_key=False)
    ...
    Bind_id: db.Mapped[Optional[str]] = db.mapped_column(db.SmallInteger(), primary_key=False)
...
class Rice_mPLoc(db.Model):
    ...
    lab_description: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    gfp: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    mass_spec: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    swissprot: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    amigo: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    annotation: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_ipsort: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_mitopred: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_mitopred2: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_predator: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_peroxp: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_subloc: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_targetp: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_wolfpsort: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_multiloc: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_loctree: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
    pred_mPLoc: db.Mapped[Optional[str]] = db.mapped_column(db.String(), primary_key=False)
