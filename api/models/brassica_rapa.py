...
class SampleData(db.Model):
    ...
    data_probeset_id: db.Mapped[str] = db.mapped_column(db.String(16), nullable=False, primary_key=True)
    data_signal: db.Mapped[float] = db.mapped_column(db.Float, primary_key=True)
    data_bot_id: db.Mapped[str] = db.mapped_column(db.String(10), nullable=False, primary_key=True)
