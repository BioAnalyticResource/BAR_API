...
class SamplesLookup(db.Model):
    ...
    sample_id = db.Column(db.String(45), primary_key=True)
    dataset = db.Column(db.String(45), primary_key=False)
    dataset_sample = db.Column(db.String(45), primary_key=False)
