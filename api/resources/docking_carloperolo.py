...
HOME = '/home/cperolo/'
RESULTS_FOLDER = HOME + 'public_html/back_end_script/results/'
UPLOAD_FOLDER = RESULTS_FOLDER + 'receptor_to_dock/'
...
def hex_docking(rec_lig, rec_lig2, receptor, ligand):
    code = """ open_receptor """ + UPLOAD_FOLDER + receptor + """.pdb
open_ligand """ + RESULTS_FOLDER + """ligand_to_dock/""" + ligand + """.pdb
...
commit_edits
activate_docking
save_range 1 500 """ + RESULTS_FOLDER + """%s_folder/%s/result %s pdb""" % (rec_lig, rec_lig2, rec_lig)
